...
Read our [Code of Conduct](https://github.com/khulnasoft/Assera/raw/main/CODE_OF_CONDUCT.md) to keep our community approachable and respectable.

Refer to the [Manual](../Manual/00%20Introduction.md) and [Tutorials](../Tutorials/README.md) to familiarize yourself with the Assera language and programming model.
...
2. Includes working Assera Python code implementing that task. At the end of the case study, the code should produce a HAT package using [`assera.Package.build()`](../Manual/10%20Packages.md).
...
All community case studies are published directly from the author's GitHub repository and linked to from the Assera GitHub repository.
...
2. Edit [Case Studies/README.md](https://github.com/khulnasoft/Assera/blob/main/docs/Case%20Studies/README.md) to add your case study to the Table of Contents. The link should point to the git SHA for your latest commit. The format to use is: https://github.com/*user*/*repo*/blob/*git_sha*/*path_to_case_study*/README.md.

3. Create a [Pull Request](https://github.com/khulnasoft/Assera/compare) to submit your edits to [Case Studies/README.md](https://github.com/khulnasoft/Assera/blob/main/docs/Case%20Studies/README.md).
