...
## `assera.Plan.cache(source[, index, trigger_index, layout, level, trigger_level, max_elements, element_type, strategy, thrifty, location, double_buffer, double_buffer_location, vectorize])`
...
`layout` | The affine memory map, if different from the source. | [`assera.Layout`](<../Array/Layout.md>).
