...
namespace lnir = assera::ir::loopnest;
namespace utilir = assera::ir::util;
namespace vir = assera::ir::value;
namespace xpir = assera::ir::executionPlan;

namespace tr = assera::transforms;
namespace lntr = assera::transforms::loopnest;
namespace vectr = assera::transforms::vectorization;
namespace vtr = assera::transforms::value;
namespace xptr = assera::transforms::executionPlan;
namespace affinetr = assera::transforms::affine;

namespace
{
struct LoopNestToValueFuncPass : public assera::transforms::LoopNestToValueFuncBase<LoopNestToValueFuncPass>
{
    ...
    void runOnOperation() final
    {
        ...
        {
            RewritePatternSet patterns(context);
            affinetr::populateAsseraAffineExprSimplificationPatterns(patterns);
            (void)applyPatternsAndFoldGreedily(vFuncOp, std::move(patterns), singleIterationConfig);
            snapshotter.Snapshot("AsseraAffineSimplification", vFuncOp);
        }
...
struct NestOpLowering : OpRewritePattern<lnir::NestOp>
{
                                  ...
                                  PatternRewriter& rewriter) const override
    {
        ...
        auto fnName = "NestFunction_" + std::to_string(assera::ir::util::GetUniqueId(nestOp));
