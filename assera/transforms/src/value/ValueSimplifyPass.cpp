...
using ValueCastOp = assera::ir::value::CastOp;
using ValueBinOp = assera::ir::value::BinOp;
...
using ValueCopyOp = assera::ir::value::CopyOp;
...
using ValueSliceOp = assera::ir::value::SliceOp;
struct ValueSliceSimplifyPattern : public OpRewritePattern<ValueSliceOp>
{
    ...
    {
        using assera::ir::value::GetElementOp;
...
void ValueSimplifyPass::runOnOperation()
{
    ...
    assera::transforms::value::populateValueSimplifyPatterns(patterns);
