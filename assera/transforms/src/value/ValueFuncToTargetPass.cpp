...
struct ValueFuncToTargetPattern : OpRewritePattern<vir::ValueFuncOp>
{
    ...
    LogicalResult matchAndRewrite(
        ...
        PatternRewriter& rewriter) const override
    {
        auto loc = rewriter.getFusedLoc({ funcOp.getLoc(), assera::ir::util::GetLocation(rewriter, __FILE__, __LINE__) });
        ...
        if (funcOp->getAttr(assera::ir::NoInlineAttrName))
        {
...
struct ValueLambdaRewritePattern : mlir::OpRewritePattern<vir::ValueLambdaOp>
{
    ...
    void rewrite(vir::ValueLambdaOp op, PatternRewriter& rewriter) const final
    {
        ...
        auto vFuncOp = [&] {
            ...
            auto loc = assera::ir::util::GetLocation(rewriter, __FILE__, __LINE__);
        ...
        [[maybe_unused]] auto launchFuncOp = rewriter.create<vir::LaunchFuncOp>(assera::ir::util::GetLocation(rewriter, __FILE__, __LINE__), vFuncOp, args);
