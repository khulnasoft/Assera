...
static arith::CmpIPredicate CmpOpPredicateToCmpIPredicate(assera::ir::value::CmpOpPredicate pred)
{
#define MAP_PREDICATE(v1, v2)                   \
    case assera::ir::value::CmpOpPredicate::v1: \
...
struct ConstantAsseraCmpOpRewrite : public mlir::OpRewritePattern<assera::ir::value::CmpOp>
{
    using OpRewritePattern::OpRewritePattern;
    LogicalResult matchAndRewrite(assera::ir::value::CmpOp op, PatternRewriter& rewriter) const final
    {
...
struct ConstantAsseraMaxMinOpRewrite : public mlir::OpRewritePattern<BinOp>
{
    using OpRewritePattern::OpRewritePattern;
...
struct RangeValueOptimizePass : public ConvertRangeValueOptimizeBase<RangeValueOptimizePass>
{
    void runOnOperation() final
    {
        ...
        assera::transforms::value::populateRangeValueOptimizePatterns(patterns);
...
void populateRangeValueOptimizePatterns(mlir::RewritePatternSet& patterns)
{
    patterns.insert<ConstantCmpIOpRewrite,
                    ConstantAsseraCmpOpRewrite,
                    ConstantAsseraMaxMinOpRewrite>(patterns.getContext());
}
