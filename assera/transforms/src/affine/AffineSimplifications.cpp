...
struct AffineSimplificationPass : public assera::transforms::AsseraAffineSimplificationBase<AffineSimplificationPass>
{
    void runOnOperation() final
    {
...

        {
            ...
            assera::transforms::affine::populateAsseraAffineExprSimplificationPatterns(patterns);
        ...
        // Apply RangeValueOptimize and affine value map simplification to try to simplify possibly-dynamic loop bounds
        {
            ...
            OwningRewritePatternList patterns(context);
            assera::transforms::affine::populateAsseraAffineLoopSimplificationPatterns(patterns);
