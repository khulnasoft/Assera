...
struct AsseraAffineLoopNormalizePass : public assera::transforms::AsseraAffineLoopNormalizeBase<AsseraAffineLoopNormalizePass>
{
...
{
    return std::make_unique<AsseraAffineLoopNormalizePass>();
}
} // namespace assera::transforms::affine
