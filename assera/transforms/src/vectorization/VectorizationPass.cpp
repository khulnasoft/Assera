...
using namespace assera::transforms::vectorization;
...
struct VectorizationPass : public assera::transforms::AsseraVectorizationPassBase<VectorizationPass>
{
...
struct VectorizationUnrollPass : public assera::transforms::AsseraVectorizationUnrollPassBase<VectorizationUnrollPass>
{
