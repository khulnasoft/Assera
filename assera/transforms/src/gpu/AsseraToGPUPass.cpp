...
#define DEBUG_TYPE "assera-to-gpu"

using namespace mlir;
using assera::transforms::populateAsseraToNVVMPatterns;
using assera::transforms::populateAsseraToROCDLPatterns;
using assera::transforms::populateAsseraToSPIRVPatterns;
using assera::transforms::populateGPUSimplificationPatterns;
using assera::transforms::populateGPUToROCDLPatterns;

namespace ir = assera::ir;
namespace utilir = assera::ir::util;
...
constexpr unsigned kAsseraGPUPatternBenefit = 10;
...
struct PrivateAllocToSPIRVConversion : public OpConversionPattern<memref::AllocOp>
{
    PrivateAllocToSPIRVConversion(SPIRVTypeConverter& typeConverter, MLIRContext* context) :
        OpConversionPattern(typeConverter, context, kAsseraGPUPatternBenefit)
    {}
...
struct AsseraToSPIRVPass : public assera::transforms::ConvertAsseraToSPIRVBase<AsseraToSPIRVPass>
{
    void runOnOperation() final
    {
        ...
        populateAsseraToSPIRVPatterns(typeConverter, context, patterns);
...
struct GPUSimplificationPass : public assera::transforms::GPUSimplificationBase<GPUSimplificationPass>
{
    void runOnOperation() final
    {
        MLIRContext* context = &getContext();
...
struct AsseraToROCDLPass : public assera::transforms::ConvertAsseraToROCDLBase<AsseraToROCDLPass>
{
    void runOnOperation() final
    {
        MLIRContext* context = &getContext();
        ...
        {
            RewritePatternSet patterns(context);
            populateAsseraToROCDLPatterns(patterns);
...
struct GPUToROCDLPass : public assera::transforms::ConvertGPUToROCDLBase<GPUToROCDLPass>
{
    void runOnOperation() final
    {
        MLIRContext* context = &getContext();
...
struct AsseraToNVVMPass : public assera::transforms::ConvertAsseraToNVVMBase<AsseraToNVVMPass>
{
    void runOnOperation() final
    {
        MLIRContext* context = &getContext();
        ...
        {
            RewritePatternSet patterns(context);
            populateAsseraToNVVMPatterns(patterns);
...
void populateAsseraToSPIRVPatterns(mlir::SPIRVTypeConverter& typeConverter, mlir::MLIRContext* context, mlir::RewritePatternSet& patterns)
{
    patterns.insert<
...
{
    using assera::value::ExecutionRuntime;
    switch (runtime)
    {
    ...
    case ExecutionRuntime::ROCM:
        return createAsseraToROCDLPass();
    case ExecutionRuntime::CUDA:
        return createAsseraToNVVMPass();
    case ExecutionRuntime::VULKAN:
        return createAsseraToSPIRVPass();
    default:
        return {};
    }
}
