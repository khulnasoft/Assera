...
namespace value
{
    ...
    public:
        ...
        static std::string GetTemporaryFunctionPointerPrefix() { return "__ASSERA_TEMPORARY__"; }
...
{
template <>
struct hash<::assera::value::FunctionDeclaration>
{
    using Type = ::assera::value::FunctionDeclaration;
