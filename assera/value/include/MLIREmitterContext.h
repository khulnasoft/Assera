...
namespace value
{
    ...
    public:
        ...
        void setMetadata(const std::string& key, const assera::ir::MetadataValueType& value);
        assera::ir::Metadata getFullMetadata();
        ...
        friend mlir::Value Unwrap(assera::value::Value&);
        friend mlir::Value UnwrapScalar(Scalar&);
        friend ViewAdapter Wrap(mlir::Value, std::optional<assera::utilities::MemoryLayout> layout);
    ...
    inline ::assera::value::MLIRContext& GetMLIRContext()
    {
        return dynamic_cast<::assera::value::MLIRContext&>(::assera::value::GetContext());
    }
} // namespace value
} // namespace assera
