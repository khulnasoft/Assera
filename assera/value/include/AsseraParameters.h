...
namespace parameter
{
    ...
    {
        ParseAsseraCommandLineOptions(argc, argv);

        ...
    }

    // Command line usage, supposing the above Assera cpp file is built into generator.exe:
    ...
    */
    ...
    namespace detail
    {
        ...
        static std::vector<const llvm::cl::OptionCategory*> AsseraCategories{
