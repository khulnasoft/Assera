...
namespace value
{
    ...
    value::TypedOperator GetOperator(LLVMType type, BinaryOperatorType operation);
    ...
    value::TypedComparison GetComparison(LLVMType type, BinaryPredicateType operation);
