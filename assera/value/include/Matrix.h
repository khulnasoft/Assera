...
namespace value
{
    ...
    public:
        ...
        /// <param name="rowStride"> The stride of the submatrix in the row dimension </param>
        /// <param name="colStride"> The stride of the submatrix in the column dimension </param>
        /// <returns> The resulting submatrix block </returns>
        Matrix SubMatrix(Scalar row, Scalar column, int numRows, int numColumns, int rowStride = 1, int colStride = 1) const;
