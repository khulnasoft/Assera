...
namespace value
{
    ...
    public:
        ...
        void Tensorize(std::vector<ScalarIndex> indices, MMAShapeType dims, int numTotalPasses, bool useStaticOffsets, int numFusedPasses, MMASchedulingPolicyType schedulingPolicy, MMAFragmentOpType prologueOp, double prologueArg, MMAFragmentOpType epilogueOp, double epilogueArg, bool _useRocWMMA)
        {
            ...
            TensorizationInfo tensorizationInfo{ static_cast<assera::ir::value::MMAShapeType>(dims), numTotalPasses, useStaticOffsets, numFusedPasses, static_cast<assera::ir::value::MMASchedulingPolicyType>(schedulingPolicy), static_cast<assera::ir::value::MMAFragmentOpType>(prologueOp), prologueArg, static_cast<assera::ir::value::MMAFragmentOpType>(epilogueOp), epilogueArg, _useRocWMMA };
    ...
    private:
        ...
        {
            return ::assera::value::GetMLIRContext().GetOpBuilder();
        }
