...
namespace assera::parameter
{

namespace detail
{
    /*extern*/ llvm::cl::OptionCategory CommonCategory("Assera Common Options");
    /*extern*/ llvm::cl::OptionCategory CustomCategory("Assera Custom Generator Options");
...
void ParseAsseraCommandLineOptions(int argc, const char** argv)
{
    llvm::sys::PrintStackTraceOnErrorSignal(argv[0], true);

    // Hide non-Assera parameters inherited from LLVM due to using llvm::cl
    llvm::cl::HideUnrelatedOptions(detail::AsseraCategories);
    llvm::cl::ParseCommandLineOptions(argc, argv, "Assera Generator\n");
}
