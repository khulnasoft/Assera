...
using namespace assera::emitters;
using namespace assera::utilities;
using namespace assera::logging;
using namespace assera::value;
using namespace assera::value::loopnests;

// template <assera::math::MatrixLayout layout>
// using LayoutType = std::integral_constant<assera::math::MatrixLayout, layout>;
...
Scalar TransformedDomain_test1()
{
    Index i("i"), j("j");
    TransformedDomain domain({ { i, { 0, 120 } },
                               { j, { 0, 200 } } });
