...
{
template <>
struct hash<::assera::utilities::DimensionVector>
{
    using Type = ::assera::utilities::DimensionVector;
...
template <>
struct hash<::assera::utilities::MemoryLayout>
{
    using Type = ::assera::utilities::MemoryLayout;
