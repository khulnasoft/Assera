...
FunctionType assera::ir::value::CallOp::getCalleeType()
{
...
static LogicalResult verify(GPUBlockCacheOp op)
{
    ...
    const auto tileShapeVec = assera::ir::util::ConvertArrayAttrToIntVector(tileShape);
