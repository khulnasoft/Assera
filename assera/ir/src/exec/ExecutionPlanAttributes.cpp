...
namespace executionPlan
{
    ...
    TensorizationInfoAttr parseTensorizationInfo(mlir::DialectAsmParser& parser)
    {
        ...
        if (useStaticOffsets != 0 && useStaticOffsets != 1)
            return {};
        return TensorizationInfoAttr::get(TensorizationInfo{ assera::ir::value::MMAShapeType{ dim }, numTotalPasses, useStaticOffsets, numFusedPasses, assera::ir::value::MMASchedulingPolicyType{ schedulingPolicy }, assera::ir::value::MMAFragmentOpType{ prologueOp }, prologueArg, assera::ir::value::MMAFragmentOpType{ epilogueOp }, epilogueArg, _useRocWMMA }, parser.getBuilder().getContext());
    }
