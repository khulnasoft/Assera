...
namespace loopnest
{
    ...
    IdWrapper LoopNestAffineConstraints::AddRangeEnd(const Range& range, std::optional<mlir::AffineExpr> localExpr)
    {
        ...
        else
        {
            ...
            throw assera::utilities::InputException(assera::utilities::InputExceptionErrors::invalidArgument, "Can only constrain an index by a constant, symbol, or other index");
        }
    }
