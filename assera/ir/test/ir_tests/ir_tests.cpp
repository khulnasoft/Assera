...
namespace lntr = assera::transforms::loopnest;
namespace xptr = assera::transforms::executionPlan;
...
protected:
    ...
    Location loc;
    assera::value::ContextGuard<assera::value::MLIRContext> _valueContext;
...
public:
        ...
        _valueContext(module)
    {
        ...
        mlirContext.appendDialectRegistry(assera::ir::GetDialectRegistry());
    ...
    void RunConversionPasses(ConversionTarget target, const std::string& filename, const assera::transforms::AsseraPassPipelineOptions& options = {})
    {
        ...
        assera::transforms::AsseraPassPipelineOptions opts{};
        opts.copyOptionValuesFrom(options);
        opts.basename = filename;
        assera::transforms::addAsseraToLLVMPassPipeline(pm, opts);

        CHECK(succeeded(mlir::verify(module)));
        if (target > ConversionTarget::assera)
        {
...
TEST_CASE_METHOD(Fixture, "Test1", "[cpu][gpu][ir]")
{
    ...
    auto conversionTarget = GENERATE(ConversionTarget::assera, ConversionTarget::mlir, ConversionTarget::llvm);
...
{
    auto target = GENERATE(ConversionTarget::assera, ConversionTarget::mlir, ConversionTarget::llvm);

    using namespace assera::value;
    using namespace assera::utilities;
    using assera::value::Value, assera::value::Matrix;
...
TEST_CASE_METHOD(Fixture, "vector_add_rocm", "[gpu][lang]")
{
    ...
    assera::transforms::AsseraPassPipelineOptions opts{};
    opts.runtime = assera::value::ExecutionRuntime::ROCM;
...
TEST_CASE_METHOD(Fixture, "barrier_test", "[gpu][lang]")
{
    using namespace assera::value;
    using namespace assera::utilities;
    using assera::utilities::MemorySpace;
    using assera::value::Value, assera::value::Matrix;
...
// Implements C = A - B
//          or C = A + B
void AddSubtract(assera::value::Matrix A, assera::value::Matrix B, assera::value::Matrix C, Operation op)
{
...
void AddSubtract2(assera::value::Matrix A, assera::value::Matrix B, assera::value::Matrix C, Operation op, Operation op2 = Operation::Same)
{
    using namespace value;
...
void Gemm(assera::value::Matrix A, assera::value::Matrix B, assera::value::Matrix C)
{
    using namespace value;
    // MLAS Value MatrixMatrixMultiply
...
// Sample matrix matrix multiply function using Assera
// This function signature matches the one in
// AsseraGemmSampleEmitter::GemmFnType
void Assera_Sample_Function(assera::value::Matrix A, assera::value::Matrix B, assera::value::Matrix C)
{
    using namespace value;
...
TEST_CASE_METHOD(Fixture, "strassen l1", "[cpu][nest][demo]")
{
    ...
    DeclareFunction("NestMatMul")
        .Parameters(
            ...
            Value({ ValueType::Float, MemoryLayout(MemoryShape{ M_, N_ }) }))
        .Define([=](Matrix A, Matrix B, Matrix C) {
            StrassenL1::Assera_Sample_Function(A, B, C);
        });
...
TEST_CASE_METHOD(Fixture, "basic_conv_skew", "[cpu][nest]")
{
    ...
    assera::transforms::AsseraPassPipelineOptions options;
...
assera::value::Schedule getTiledSchedule(assera::value::Array& A, assera::value::Array& B)
{
    assera::value::Nest nest({ 16, 16 });
    auto indices = nest.GetIndices();
    auto i = indices[0];
    auto j = indices[1];
    nest.Set([&]() {
    ...
    auto matmul =
        DeclareFunction("NestMatMul")
            ...
            .Define([=](Matrix A, Matrix B, Matrix C) {
                ...
                plan.AddCache(A, ii, ii, assera::utilities::DimensionOrder(2), std::nullopt, false, true, CacheStrategyType::Striped, std::nullopt, CacheIndexing::GlobalToPhysical, CacheAllocation::Automatic, MemorySpace::Shared, MemorySpace::Private, std::nullopt);
                plan.AddCache(B, ii, ii, assera::utilities::DimensionOrder(2), std::nullopt, false, true, CacheStrategyType::Blocked, std::nullopt, CacheIndexing::GlobalToPhysical, CacheAllocation::Automatic, MemorySpace::Shared, MemorySpace::Private, std::nullopt);
            });
    ...
    auto matmul =
        DeclareFunction("NestMatMul")
            ...
            .Define([=](Matrix A, Matrix B, Matrix C) {
                ...
                plan.AddCache(A, ii, ii, assera::utilities::DimensionOrder(2), std::nullopt, false, false, CacheStrategyType::Striped, std::nullopt, CacheIndexing::GlobalToPhysical, CacheAllocation::Automatic, MemorySpace::Shared, MemorySpace::None, std::nullopt);
                plan.AddCache(B, ii, ii, assera::utilities::DimensionOrder(2), std::nullopt, false, false, CacheStrategyType::Blocked, std::nullopt, CacheIndexing::GlobalToPhysical, CacheAllocation::Automatic, MemorySpace::Shared, MemorySpace::None, std::nullopt);
            });
