...
#ifndef MLIR_DIALECT_ARGO_TRAITS_H_
#define MLIR_DIALECT_ARGO_TRAITS_H_
...
namespace OpTrait
{
    namespace argo
    {
        ...
        /// number of inputs and outputs, all passed as operands.
        template <unsigned N>
        class NInputs
        {
        public:
        ...
        /// trait like this:
        ///
        ///   class XXXOp : public Op<XXXOp, OpTrait::ViewTrait> {
        ///
        ...
        public:
            ...
            ArrayAttr iterator_types()
            {
                ...
                auto attr = ArrayAttr::get(ctx, llvm::to_vector<4>(attrRange));
...
#endif // MLIR_DIALECT_ARGO_TRAITS_H_
