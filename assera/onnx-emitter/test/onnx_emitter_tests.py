...
# onnx is not automatically present on an assera system
# fail gracefully if the dependencies are not installed
try:
    import onnx
except ImportError:
    print("""[WARNING] onnx not installed, skipping tests.
You can fix this by running pip install -r assera/onnx-emitter/test/requirements.txt""")
    exit(0)
...
from assera import onnx_emitter
