...
class Array:
    ...
    def __init__(
        ...
        element_type: Union["assera.ScalarType", type] = None,
        layout: Union["assera.Array.Layout", Tuple[int]] = Layout.FIRST_MAJOR,
        offset: int = 0,
        shape: Tuple[Union[int, DelayedParameter, Dimension]] = None,
        flags: "assera.AllocateFlags" = AllocateFlags.NONE
    ):
        """Creates an Array
    ...
    def deferred_layout(self, cache: "assera.Cache"):
