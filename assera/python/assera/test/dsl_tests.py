...
# python -m unittest discover -k "test_input_array" path_to_assera/test dsl_tests.py
# python -m unittest discover -k "DSLTest_01" path_to_assera/test dsl_tests.py
...
from assera import ScalarType, Array, Function, Nest, Target, Package, algorithms, cast, AllocateFlags, Role
from assera.test import verifiers
from assera.test.test_utils import expectedFailure, FailedReason, avx2_cpu, get_avx_platform
from assera._lang_python._lang import Dimension, EnterProfileRegion, ExitProfileRegion, PrintProfileResults
...
class DSLTest_01Arrays(unittest.TestCase):
    ...
    def test_reinterpret_cast_partially_dynamic_shape(self) -> None:
        from assera import create_dimensions
    ...
    def test_output_array_range_node1(self) -> None:
        from assera import create_dimensions, floor, cast
        from assera._lang_python._lang import Scalar
    ...
    def test_output_array_range_node2(self) -> None:
        from assera import create_dimensions, floor, cast
        from assera._lang_python._lang import Scalar, Dimension
...
class DSLTest_02SimpleAffineLoopNests(unittest.TestCase):
    ...
    def test_relational_operations(self) -> None:
        from assera._lang_python._lang import _If
    ...
    def test_logical_operations(self) -> None:
        from assera import logical_and, logical_or, logical_not
    ...
    def test_round_intrinsic(self) -> None:
        from assera import round as accround
    ...
    #     from assera import remainderf, cast
...
class DSLTest_04Fusing(unittest.TestCase):
    ...
    def test_partial_iteration_space_fusing_1(self) -> None:
        from assera import fuse, Nest, max
        from assera._lang_python._lang import Scalar
...
class DSLTest_07PlansVectorizationParallelization(unittest.TestCase):
    ...
    def test_unroll(self) -> None:
        from assera import Target, Nest
...
class DSLTest_09Parameters(unittest.TestCase):
    ...
    def test_parameterization_1(self) -> None:
        from assera import create_parameters, Nest
    ...
    def test_parameterization_5(self) -> None:
        from assera import create_parameters
    ...
    def test_parameterization_grid(self) -> None:
        from assera import create_parameters, create_parameter_grid, Nest, Schedule
    ...
    def test_parameterization_loopIndex_order(self) -> None:
        from assera import create_parameter_grid, create_parameters, Nest
    ...
    def test_fusion_parameterization_1(self) -> None:
        from assera import create_parameters, Nest, fuse
    ...
    def test_fusion_parameterization_4(self) -> None:
        from assera import create_parameters, Nest, fuse, create_parameter_grid
    ...
    def test_parameterization_auxiliary_data(self) -> None:
        ...
        for function in functions:
            data_point = function.auxiliary["assera"]["parameters"]
            if data_point:
