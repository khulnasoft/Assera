...
from assera._lang_python import Role
from assera._lang_python._lang import _MemorySpace
from assera.test import verifiers
from assera.test.test_utils import expectedFailure, FailedReason, get_type_str
from assera import Array, Nest, Package, ScalarType, Target, Constants, MMAShape, MMASchedulingPolicy, MMAFragmentOp, CacheStrategy
from assera.Targets import GridUnits
...
class TensorizeTest(unittest.TestCase):
    ...
    def _rocm_matmul(self, test_name, M, N, K, block_tile, outer_tile_k, thread_tile=None, thread_coarsening_tile=(1, 1), inner_tile_k=None,
        ...
        from assera import Array, Nest, Package, Target
    ...
    def _matmul_relu(self, test_name, M, N, K, block_tile, outer_tile_k, thread_tile=None, thread_coarsening_tile=(1, 1), inner_tile_k=None,
                    ...
                    array_element_types=[ScalarType.float32, ScalarType.float32, ScalarType.float32],
                    file_check_fn=None, tolerance=1e-5) -> None:
        from assera import Array, Package, Target
    ...
    def test_rocm_tensorize_single_block_single_warp_output(self) -> None:
        from assera import Array, Nest, Package, ScalarType, Target
    ...
    def test_benchmark(self) -> None:
        from assera import Package, Target
        from assera_gemm import benchmark_kernel
