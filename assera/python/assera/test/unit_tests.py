...
from assera import Package, Role
...
class ModuleScope:
    ...
    def __enter__(self):
        from assera._lang_python import _SetActiveModule, _ClearActiveModule
        _ClearActiveModule()
...
class ContainerTypesTests(unittest.TestCase):
    def test_valor(self) -> None:
        from assera import ScalarType
        from assera._lang_python import _MemoryLayout
        from assera._lang_python._lang import _Valor, ViewAdapter
    ...
    def test_scalar(self) -> None:
        from assera import ScalarType, Scalar, as_index
        from assera._lang_python import _MemoryLayout
        from assera._lang_python._lang import Array, ViewAdapter, _Valor
    ...
    def test_cast(self) -> None:
        from assera import cast, Array, Nest, ScalarType
...
class PackagingTypesTests(unittest.TestCase):
    def test_compiler_options(self) -> None:
        from assera import CompilerOptions, _GetTargetDeviceFromName
    ...
    def test_module(self) -> None:
        from assera import CompilerOptions
        from assera._lang_python import _Module
    ...
    def test_conditional_function(self) -> None:
        from assera import ScalarType, Package, Nest, Array, Scalar, as_index
    ...
    def test_package_single_target_enforcement(self) -> None:
        from assera import ScalarType, Package, Target, Nest, Array
    ...
    def test_default_module_specialization(self) -> None:
        from assera import ScalarType, Target, Nest, Array
    ...
    def test_cross_module_references(self) -> None:
        from assera import CompilerOptions, Array
        from assera._lang_python import _Module, _ResolveConstantDataReference
        import numpy as np
    ...
    def test_add_callable_function(self) -> None:
        from assera import Array, ScalarType, Nest
...
class ExecutionPlanTypesTests(unittest.TestCase):
    def test_gpu_config(self) -> None:
        from assera._lang_python._lang import _GPU, _Dim3
...
class LogicTypesTests(unittest.TestCase):
    def test_if_context(self) -> None:
        from assera._lang_python._lang import _If, Scalar
    ...
    def test_logic(self) -> None:
        from assera import logic_function
    ...
    def test_conditional_logic(self) -> None:
        from assera import ScalarType, Nest, Array, as_index
        from assera._lang_python._lang import _If
