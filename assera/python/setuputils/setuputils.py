...
def developer_mode():
    ...
    # TODO: any better way?
    return os.environ.get("ASSERA_PACKAGE_FOR_CI", "0") != "1"
...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        with ChdirRepoRoot():    # CMake must be run at the repository root
            ...
            # ASSERA_VERSION_INFO shows you how to pass a value into the C++ code
            # from Python.
            cmake_args = [
                f"-DPYTHON_EXECUTABLE={sys.executable}",
                f"-DASSERA_VERSION_INFO={self.distribution.get_version()}",
            ...
            component = self.component or "assera"
            ...
            if developer_mode() and is_top_level_package():
                ...
                for component in ["assera-compilers", "assera-llvm", "assera-gpu"]:
                    subprocess.check_call(
                        ["cmake", "--install", ".", "--prefix", install_dir, "--component", component, "--config", cfg],
                        cwd=cwd)
