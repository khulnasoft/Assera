...
namespace testing
{
    ...
    /// <summary> Get a vector of test-failed messages. </summary>
    ///
    /// <returns> A `vector<string>` of test-failure messages. </returns>
    std::vector<std::string> GetFailedTests();

    /// <summary> Get a vector of test-success messages. </summary>
    ///
    /// <returns> A `vector<string>` of test-success messages. </returns>
    std::vector<std::string> GetSuccessfulTests();

    /// <summary> Get a vector of test-warning messages. </summary>
    ///
    /// <returns> A `vector<string>` of test-warning messages. </returns>
    std::vector<std::string> GetTestWarnings();

    /// <summary> Print a summary of the test results. </summary>
    /// Prints the total number of tests, and the number of successes, failures, and warnings.
    void PrintTestSummary();

    // <summary> Print details of the test results. </summary>
    /// Prints the test message for each of the successful and failed tests, and the tests that produced warnings.
    ...
    /// <summary> Reset the test state to "no tests failed". </summary>
    void Reset();
