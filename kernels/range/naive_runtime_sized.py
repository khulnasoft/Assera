...
# Prototype only - meant to illustrate future versions of Assera
...
def generate():
    ...
    #     void _assera_allocate(void** memory, size_t bytes);
    #
    package = acc.Package()
...
def verify():
    ...
    # without running Assera (until Assera implements runtime sizes)
