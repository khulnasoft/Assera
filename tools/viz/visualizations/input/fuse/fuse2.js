...
async function RunViz(Viz, SceneView) {
    ...
    // space_pair.root_object.rotation.x = 0.5;
    space_pair.root_object.rotation.y = -0.05;
    space_pair.root_object.rotation.z = 0.02;    
