...
set(ASSERA_TABLEGEN_OUTPUT_DIR ${CMAKE_BINARY_DIR}/docs/sphinx_source/ir)

function(add_assera_ir_doc doc_filename command output_file output_directory)
  set(LLVM_TARGET_DEFINITIONS ${doc_filename}.td)
  tablegen(MLIR ${output_file}.md ${command} "-I${MLIR_MAIN_INCLUDE_DIR}" "-I${MLIR_INCLUDE_DIR}")
  set(GEN_DOC_FILE ${ASSERA_TABLEGEN_OUTPUT_DIR}/${output_directory}${output_file}.md)
  add_custom_command(
          OUTPUT ${GEN_DOC_FILE}
