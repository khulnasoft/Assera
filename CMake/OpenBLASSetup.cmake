        ...
        if(EXISTS ${BLAS_PACKAGE_DIR}/lib/libopenblas.lib)
            ...
            if("${processor_to_use}" IN_LIST supported_processors)
                ...
                if(NOT IS_DIRECTORY "${BLAS_PACKAGE_DIR}")
                    message(STATUS "Searching ASSERA_ROOT=$ENV{ASSERA_ROOT} for OpenBlas")
                    set(BLAS_PACKAGE_DIR $ENV{ASSERA_ROOT}/external/${BLAS_PACKAGE_NAME}.${BLAS_PACKAGE_VERSION}/build/native/x64/${processor_generation})
                endif()
...
if(BLAS_LIBS AND BLAS_INCLUDE_DIRS)
    ...
    set(BLAS_FOUND "YES")
    add_compile_definitions(BLAS_INCLUDE_HEADER="cblas.h")
